...
![](https://cdn.jsdelivr.net/gh/qiyuor2/blog-image/img/newrepo.png)

![](https://cdn.jsdelivr.net/gh/qiyuor2/blog-image/img/nreponame.png)
...
![](https://cdn.jsdelivr.net/gh/qiyuor2/blog-image/img/settingnewtoken.png)

![](https://cdn.jsdelivr.net/gh/qiyuor2/blog-image/img/newtokendevset.png)

![](https://cdn.jsdelivr.net/gh/qiyuor2/blog-image/img/settokenlist.png)

![](https://cdn.jsdelivr.net/gh/qiyuor2/blog-image/img/settokenselect.png)

点击**Generate token**

![](https://cdn.jsdelivr.net/gh/qiyuor2/blog-image/img/finishgithubtoken.png)

请务必保存好生成的 Token，它只会显示这一次

![](https://cdn.jsdelivr.net/gh/qiyuor2/blog-image/img/finishgithubtoken02.png)
...
- 设置自定义域名，我们这里要使用 jsDelivr 加速访问，所以要填上**https://cdn.jsdelivr.net/gh/用户名/图床仓库名**

![](https://cdn.jsdelivr.net/gh/qiyuor2/blog-image/img/picgoconfig.png)

配置完成后，就可以在 PicGo 上传区上传图片了，上传图片成功后就可以通过**https://cdn.jsdelivr.net/gh/用户名/图床仓库名/图片名.后缀**访问到图片了，速度很快。
