...
const _sfc_main$K = {
  ...
  setup(__props, { expose }) {
    const frontmatter = {
      ...
      summary:
        '\u8001\u5E08\u5728\u8BB2C#\u5B9E\u6218\u9879\u76EE\u65F6\u6240\u4F7F\u7528\u7684SqlHelper\uFF0C\u4F7F\u7528\u7684\u6570\u636E\u5E93\u662FSQL Server',
      meta: [{ property: 'og:title', content: 'C# \u5C01\u88C5SqlHelper' }],
    }
    expose({ frontmatter })
    const head$1 = {
      title: 'C# \u5C01\u88C5SqlHelper',
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.ssrRenderAttrs(
        vue.mergeProps({ class: 'markdown-body' }, _attrs)
      )}><p>\u8001\u5E08\u5728\u8BB2C#\u5B9E\u6218\u9879\u76EE\u65F6\u6240\u4F7F\u7528\u7684SqlHelper\uFF0C\u4F7F\u7528\u7684\u6570\u636E\u5E93\u662FSQL Server</p><p><strong>\u6CE8\u610F\uFF0C\u8FDE\u63A5\u6570\u636E\u5E93\u7684\u8FDE\u63A5\u5B57\u7B26\u4E32\u9700\u8981\u5728\u914D\u7F6E\u6587\u4EF6\u4E2D\u8BBE\u7F6E\u597D</strong></p><pre class="language-XML"><code class="language-XML">&lt;appSettings&gt;
...
_sfc_main$K.setup = (props, ctx) => {
  ...
  ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'src/posts/2019/chsarp-sql-helper.md'
  )
...
_sfc_main$J.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext()
  ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'src/posts/2019/csharp-html-agility-pack-selenium.md'
  )
...
const meta$v = [
  {
    property: 'og:title',
    content: 'C# HtmlAgilityPack\u722C\u53D6\u9759\u6001\u9875\u9762',
  },
]
const _sfc_main$I = {
  __ssrInlineRender: true,
...
_sfc_main$I.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext()
  ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'src/posts/2019/csharp-html-agility-pack.md'
  )
...
_sfc_main$H.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext()
  ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'src/posts/2019/csharp-use-xml.md'
  )
...
const summary$t =
  '\u672C\u7BC7\u6587\u7AE0\u4ECB\u7ECDGit\u7684\u672C\u5730\u4F7F\u7528'
const meta$t = [
  { property: 'og:title', content: 'Git\u5B66\u4E60\u8BB0\u5F55' },
]
const _sfc_main$G = {
  __ssrInlineRender: true,
  setup(__props, { expose }) {
    const frontmatter = {
      ...
      summary:
        '\u672C\u7BC7\u6587\u7AE0\u4ECB\u7ECDGit\u7684\u672C\u5730\u4F7F\u7528',
      meta: [{ property: 'og:title', content: 'Git\u5B66\u4E60\u8BB0\u5F55' }],
    }
    expose({ frontmatter })
    const head$1 = {
      title: 'Git\u5B66\u4E60\u8BB0\u5F55',
...
_sfc_main$G.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext()
  ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'src/posts/2019/git-tutorial.md'
  )
...
const meta$s = [
  { property: 'og:title', content: '\u642D\u5EFAhexo\u9759\u6001\u535A\u5BA2' },
]
const _sfc_main$F = {
  __ssrInlineRender: true,
  setup(__props, { expose }) {
...
const _sfc_main$D = {
  ...
  setup(__props, { expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.ssrRenderAttrs(
        vue.mergeProps({ class: 'markdown-body' }, _attrs)
      )}><blockquote><p>\u5229\u7528 JS \u4E2D\u7684 Date \u5BF9\u8C61\u5373\u53EF\u5B9E\u73B0</p></blockquote><h3 id="js-%E4%BB%A3%E7%A0%81" tabindex="-1">js \u4EE3\u7801</h3><pre class="language-js"><code class="language-js"><span class="token operator">&lt;</span>script<span class="token operator">&gt;</span>
...
_sfc_main$D.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext()
  ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'src/posts/2019/js-count-down.md'
  )
...
const _sfc_main$C = {
  ...
  setup(__props, { expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.ssrRenderAttrs(
        vue.mergeProps({ class: 'markdown-body' }, _attrs)
      )}><h2 id="js-%E4%BB%A3%E7%A0%81" tabindex="-1">JS \u4EE3\u7801</h2><pre class="language-javascript"><code class="language-javascript"><span class="token keyword">function</span> <span class="token function">$</span><span class="token punctuation">(</span><span class="token parameter">id</span><span class="token punctuation">)</span> <span class="token punctuation">{</span> <span class="token keyword">return</span> document<span class="token punctuation">.</span><span class="token function">getElementById</span><span class="token punctuation">(</span>id<span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token punctuation">}</span>
...
_sfc_main$C.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext()
  ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'src/posts/2019/js-move-pic-by-slider.md'
  )
...
const meta$o = [
  { property: 'og:title', content: 'T-SQL\u5B66\u4E60\u7B14\u8BB0' },
]
const _sfc_main$B = {
  __ssrInlineRender: true,
  setup(__props, { expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.ssrRenderAttrs(
        vue.mergeProps({ class: 'markdown-body' }, _attrs)
      )}><p>\u5B66\u4E60 T-SQL \u65F6\u8BB0\u5F55\u7684\u7B14\u8BB0\uFF0C\u8BB0\u5F97\u5E76\u4E0D\u5168\u4E5F\u4E0D\u8BE6\u7EC6</p><h2 id="if-%E5%92%8C-while-%E8%AF%AD%E5%8F%A5" tabindex="-1">if \u548C while \u8BED\u53E5</h2><pre class="language-sql"><code class="language-sql"><span class="token keyword">declare</span> <span class="token variable">@age</span> <span class="token keyword">int</span>
...
const meta$m = [
  {
    property: 'og:title',
    content: '\u4F7F\u7528 webpack \u624B\u52A8\u642D\u5EFA vue \u9879\u76EE',
  },
]
const _sfc_main$z = {
  __ssrInlineRender: true,
...
_sfc_main$z.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext()
  ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'src/posts/2020/build-vue-for-webpack.md'
  )
...
_sfc_main$y.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext()
  ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'src/posts/2020/deep-in-js-data-type.md'
  )
...
const meta$k = [
  { property: 'og:title', content: 'Electron\u8E29\u5751\u8BB0\u5F55' },
]
const _sfc_main$x = {
  __ssrInlineRender: true,
  setup(__props, { expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.ssrRenderAttrs(
        vue.mergeProps({ class: 'markdown-body' }, _attrs)
      )}><h2 id="%E5%AE%89%E8%A3%85" tabindex="-1">\u5B89\u88C5</h2><p>\u5728\u56FD\u5185\u5B89\u88C5<code>electron</code>\u7684\u65F6\u5019\uFF0C\u53EF\u80FD\u4F1A\u56E0\u4E3A\u7F51\u7EDC\u539F\u56E0\u9047\u5230\u5361\u5728<code>Building fresh packages...</code>\uFF08yarn\uFF09\u6216\u8005\u662F\u5361\u5728<code>node install.js</code>\uFF08npm\uFF09\u8FD9\u4E00\u6B65\u4E0A\u3002</p><p>\u5728\u9879\u76EE\u7684\u6839\u76EE\u5F55\u4E0B\u521B\u5EFA<code>.yarnrc</code>\u6216<code>.npmrc</code>\u7136\u540E\u8F93\u5165\u5982\u4E0B\u5185\u5BB9\u66F4\u6539\u5404\u4F9D\u8D56\u7684\u6E90\uFF0C\u5373\u53EF\u89E3\u51B3\u8BE5\u95EE\u9898\u3002</p><pre><code>registry &quot;https://registry.npm.taobao.org&quot;
...
_sfc_main$x.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext()
  ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'src/posts/2020/electron-learn.md'
  )
...
_sfc_main$w.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext()
  ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'src/posts/2020/js-datastructure.md'
  )
...
_sfc_main$v.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext()
  ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'src/posts/2020/node-spider-csdn.md'
  )
...
_sfc_main$u.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext()
  ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'src/posts/2020/picgo-jsdelivr-github.md'
  )
...
const _sfc_main$q = {
  ...
  setup(__props, { expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.ssrRenderAttrs(
        vue.mergeProps({ class: 'markdown-body' }, _attrs)
      )}><p>\u6700\u8FD1\u5728\u5B66\u4E60\u8BBE\u8BA1\u6A21\u5F0F\uFF0C\u53C8\u6B63\u597D\u521A\u4E0A\u624B\u4E86 typescript\uFF0C\u5C31\u60F3\u8981\u7528 ts \u5B9E\u73B0\u4E00\u4E0B\u8BD5\u8BD5\u3002</p><p>\u5355\u4F8B\u6A21\u5F0F\u7684\u76EE\u7684\u662F\u9650\u5236\u4E00\u4E2A\u7C7B\u53EA\u80FD\u88AB\u5B9E\u4F8B\u5316\u4E00\u6B21\uFF0C\u63D0\u4F9B\u4E00\u4E2A\u5168\u5C40\u7684\u8BBF\u95EE\u70B9\u3002\u5355\u4F8B\u6A21\u5F0F\u53C8\u88AB\u5206\u4E3A\u61D2\u6C49\u5355\u4F8B\u6A21\u5F0F\u548C\u997F\u6C49\u5355\u4F8B\u6A21\u5F0F\uFF0C\u61D2\u6C49\u5355\u4F8B\u6A21\u5F0F\u5C31\u662F\u5728\u7B2C\u4E00\u6B21\u8C03\u7528\u65F6\u5B9E\u4F8B\u5316\uFF0C\u997F\u6C49\u5355\u4F8B\u6A21\u5F0F\u662F\u7C7B\u52A0\u8F7D\u65F6\u5C31\u5B9E\u4F8B\u5316\u3002</p><p><strong>\u6838\u5FC3\u8981\u70B9\uFF1A</strong></p><p>\u628A\u4E00\u4E2A\u9759\u6001\u79C1\u6709\u53D8\u91CF\u786E\u7ACB\u4E3A\u552F\u4E00\u7684\u5B9E\u4F8B\uFF0C\u5916\u90E8\u901A\u8FC7\u9759\u6001\u65B9\u6CD5\u8BBF\u95EE\u8FD9\u4E2A\u552F\u4E00\u7684\u5B9E\u4F8B\uFF0C\u5E76\u628A\u6784\u9020\u51FD\u6570\u8BBE\u4E3A\u79C1\u6709\u3002</p><h2 id="%E6%87%92%E6%B1%89%E5%8D%95%E4%BE%8B%E6%A8%A1%E5%BC%8F" tabindex="-1">\u61D2\u6C49\u5355\u4F8B\u6A21\u5F0F</h2><pre class="language-typescript"><code class="language-typescript"><span class="token keyword">class</span> <span class="token class-name">PeopleSingle</span> <span class="token punctuation">{</span>
...
_sfc_main$q.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext()
  ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'src/posts/2020/ts-singleton.md'
  )
...
const _sfc_main$p = {
  ...
  setup(__props, { expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.ssrRenderAttrs(
        vue.mergeProps({ class: 'markdown-body' }, _attrs)
      )}><blockquote><p>\u7B56\u7565\u6A21\u5F0F\uFF08Strategy\uFF09\uFF1A\u5B83\u5B9A\u4E49\u4E86\u7B97\u6CD5\u5BB6\u65CF\uFF0C\u5206\u522B\u5C01\u88C5\u8D77\u6765\uFF0C\u8BA9\u5B83\u4EEC\u4E4B\u95F4\u53EF\u4EE5\u4E92\u76F8\u66FF\u6362\uFF0C\u6B64\u6A21\u5F0F\u8BA9\u7B97\u6CD5\u7684\u53D8\u5316\u4E0D\u4F1A\u5F71\u54CD\u5230\u4F7F\u7528\u7B97\u6CD5\u7684\u5BA2\u6237\u3002</p><p>\u2014\u2014\u300A\u5927\u8BDD\u8BBE\u8BA1\u6A21\u5F0F\u300B</p></blockquote><p>\u7B56\u7565\u6A21\u5F0F\u4E3B\u8981\u7528\u6765\u89E3\u51B3\u5F53\u6709\u591A\u79CD\u76F8\u4F3C\u7B97\u6CD5\u7684\u65F6\uFF0C\u4F7F\u7528 if\u2026else \u4EA7\u751F\u7684\u96BE\u4EE5\u7EF4\u62A4\u7684\u95EE\u9898\u3002\u5B83\u4E3B\u8981\u7531\u4E09\u90E8\u5206\u7EC4\u6210\uFF1AStrategy \u63A5\u53E3\u3001\u5177\u4F53\u7684 Strategy \u7C7B\u4EE5\u53CA\u7528\u6765\u6539\u53D8\u548C\u6267\u884C\u7B56\u7565\u7684 Context \u7C7B\u3002</p><p>\u63A5\u4E0B\u6765\u5C06\u4EE5\u4E00\u4E2A\u8D85\u5E02\u9009\u62E9\u4F18\u60E0\u6D3B\u52A8\u7684\u4F8B\u5B50\u5B9E\u73B0\u7B56\u7565\u6A21\u5F0F\u3002</p><p><strong>Strategy \u63A5\u53E3</strong></p><pre class="language-typescript"><code class="language-typescript"><span class="token keyword">interface</span> <span class="token class-name">Strategy</span> <span class="token punctuation">{</span>
  <span class="token comment">/**
   * \u4F18\u60E0\u6D3B\u52A8
   * @param money \u539F\u4EF7
   * @returns \u73B0\u4EF7
...
_sfc_main$o.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext()
  ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'src/posts/2020/use-github-actions.md'
  )
...
_sfc_main$n.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext()
  ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'src/posts/2021/chrome-ext-get-image.md'
  )
...
const _sfc_main$m = {
  ...
  setup(__props, { expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.ssrRenderAttrs(
        vue.mergeProps({ class: 'markdown-body' }, _attrs)
      )}><p>src \u548C href \u90FD\u662F\u7528\u6765\u5F15\u5165\u5916\u90E8\u8D44\u6E90\u7684\u5C5E\u6027\uFF0C\u4F8B\u5982\uFF1A\u56FE\u7247\u3001\u89C6\u9891\u3001CSS \u6587\u4EF6\u3001JavaScript \u6587\u4EF6\u7B49\u3002 \u90A3\u4E48\u5B83\u4EEC\u4E24\u8005\u4E4B\u95F4\u7A76\u7ADF\u6709\u4EC0\u4E48\u6837\u7684\u533A\u522B\u5462\uFF1F</p><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>link</span> <span class="token attr-name">href</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>style.css<span class="token punctuation">&quot;</span></span> <span class="token attr-name">rel</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>stylesheet<span class="token punctuation">&quot;</span></span> <span class="token punctuation">/&gt;</span></span>
...
_sfc_main$m.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext()
  ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'src/posts/2021/difference-between-src-href.md'
  )
...
_sfc_main$l.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext()
  ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'src/posts/2021/github-actions-publish-package.md'
  )
...
_sfc_main$k.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext()
  ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'src/posts/2021/js-event-loop.md'
  )
  return _sfc_setup$k ? _sfc_setup$k(props, ctx) : void 0
}
...
const meta$6 = [
  {
    property: 'og:title',
    content: 'React Native\u4E2D\u4F7F\u7528Markdown\u7F16\u8F91\u5668',
  },
]
const _sfc_main$j = {
  __ssrInlineRender: true,
...
_sfc_main$j.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext()
  ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'src/posts/2021/package-md-editor-for-rn.md'
  )
  return _sfc_setup$j ? _sfc_setup$j(props, ctx) : void 0
}
...
_sfc_main$i.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext()
  ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'src/posts/2021/simple-blog-generate.md'
  )
  return _sfc_setup$i ? _sfc_setup$i(props, ctx) : void 0
}
...
const _sfc_main$h = {
  ...
  setup(__props, { expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.ssrRenderAttrs(
        vue.mergeProps({ class: 'markdown-body' }, _attrs)
      )}><p>\u4F7F\u7528 webpack \u642D\u5EFA\u5355\u9875\u9762\u7A0B\u5E8F\u5341\u5206\u5E38\u89C1\uFF0C\u4F46\u5728\u5B9E\u9645\u5F00\u53D1\u4E2D\u6211\u4EEC\u53EF\u80FD\u8FD8\u4F1A\u6709\u5F00\u53D1\u591A\u9875\u9762\u7A0B\u5E8F\u7684\u9700\u6C42\uFF0C\u56E0\u6B64\u6211\u7814\u7A76\u4E86\u4E00\u4E0B\u5982\u4F55\u4F7F\u7528 webpack \u642D\u5EFA\u591A\u9875\u9762\u7A0B\u5E8F\u3002</p><h2 id="%E5%8E%9F%E7%90%86" tabindex="-1">\u539F\u7406</h2><p>\u5C06\u6BCF\u4E2A\u9875\u9762\u6240\u5728\u7684\u6587\u4EF6\u5939\u90FD\u770B\u4F5C\u662F\u4E00\u4E2A\u5355\u72EC\u7684\u5355\u9875\u9762\u7A0B\u5E8F\u76EE\u5F55\uFF0C\u914D\u7F6E\u591A\u4E2A<code>entry</code>\u4EE5\u53CA<code>html-webpack-plugin</code>\u5373\u53EF\u5B9E\u73B0\u591A\u9875\u9762\u6253\u5305\u3002</p><p>\u4E0B\u9762\u4E3A\u672C\u9879\u76EE\u76EE\u5F55\u7ED3\u6784</p><pre><code>.
\u251C\u2500 src
\u2502  \u2514\u2500 pages
\u2502       \u251C\u2500 about
\u2502       \u2502    \u251C\u2500 index.css
...
_sfc_main$h.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext()
  ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'src/posts/2021/webpack-multipage.md'
  )
  return _sfc_setup$h ? _sfc_setup$h(props, ctx) : void 0
}
  ...
  setup(__props, { expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(
        `<div${serverRenderer.ssrRenderAttrs(
          vue.mergeProps({ class: 'markdown-body' }, _attrs)
        )}><p><img src="https://cdn.jsdelivr.net/gh/qiyuor2/blog-image/img/20210122takagai-san.jpeg" alt=""></p><p>\u5BF9\u4E8E\u8FD9\u90E8\u756A\u6211\u8FD8\u80FD\u8BF4\u4EC0\u4E48\uFF1F\uFF01\u592A\u751C\u4E86\u5427\uFF01\u5018\u82E5\u6709\u4EBA\u8981\u95EE\u6211\u4EC0\u4E48\u624D\u7B97\u53CC\u5411\u5954\u8D74\u7684\u7231\u60C5\uFF0C\u6211\u4E00\u5B9A\u4F1A\u63A8\u8350\u4ED6\u53BB\u770B\u770B\u9AD8\u6728\u540C\u5B66\u3002</p><p>\u7231\u8C03\u60C5\u7684\u9AD8\u6728\u540C\u5B66\u548C\u72D7\u76F4\u7537\u897F\u7247\uFF0C\u8FD9\u662F\u6211\u521A\u770B\u8FD9\u90E8\u756A\u65F6\u5BF9\u7537\u5973\u4E3B\u7684\u8BC4\u4EF7\uFF0C\u4F46\u662F\u5F53\u5267\u60C5\u4E00\u6B65\u6B65\u63A8\u8FDB\uFF0C\u6211\u6C89\u4E0B\u5FC3\u6765\u53BB\u4EAB\u53D7\u72D7\u7CAE\u7684\u65F6\u5019\uFF0C\u5C31\u53D1\u73B0\u897F\u7247\u867D\u7136\u72D7\u76F4\u7537\u4F46\u603B\u80FD\u4EE5\u72D7\u76F4\u7537\u7684\u65B9\u5F0F\u7ED9\u4E88\u9AD8\u6728\u8DB3\u591F\u7684\u56DE\u5E94\u3002\u9AD8\u6728\u5728\u897F\u7247\u623F\u95F4\u91CC\u770B\u5230\u90A3\u4E9B\u6709\u7740\u5979\u7684\u75D5\u8FF9\u7684\u7269\u54C1\u3001\u653E\u5B66\u8DEF\u4E0A\u65E0\u610F\u4E2D\u7684\u300C\u4F1A\u5FC3\u4E00\u51FB\u300D\u3001\u53CA\u65F6\u53D1\u73B0\u9AD8\u6728\u4E0D\u6B63\u5E38\u7684\u60C5\u7EEA\u5E76\u4E14\u7ED9\u5979\u5B89\u6170\u3001\u6797\u95F4\u6821\u56ED\u7684\u5DE7\u5408\u3001\u590F\u65E5\u796D\u7684\u9080\u8BF7\u2026\u2026\u8FD9\u4E00\u5207\u7684\u4E00\u5207\u90FD\u662F\u897F\u7247\u5BF9\u4E8E\u9AD8\u6728\u60C5\u611F\u7684\u771F\u8BDA\u56DE\u5E94\u3002</p><p>\u7231\u60C5\u5E76\u4E0D\u662F\u4E00\u65B9\u8F6E\u9504\u5934\u54D0\u54D0\u51FF\u5FC3\u4E4B\u58C1\u5C31\u5B8C\u4E8B\u4E86\uFF0C\u53EA\u6709\u53CC\u65B9\u6709\u6765\u6709\u56DE\u624D\u80FD\u771F\u6B63\u63A8\u52A8\u8FDB\u5EA6\u6761\u524D\u8FDB\u3002</p></div>`
      )
    }
  },
}
...
const _sfc_main$e = {
  ...
  setup(__props, { expose }) {
    const frontmatter = {
      ...
      cover:
        'https://cdn.jsdelivr.net/gh/qiyuor2/blog-image/img/20210122tiger.jpeg',
      meta: [{ property: 'og:title', content: '\u9F99\u4E0E\u864E' }],
    }
    expose({ frontmatter })
    const head$1 = {
      title: '\u9F99\u4E0E\u864E',
...
_sfc_main$e.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext()
  ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'src/posts/2022/tiger-and-dragon.md'
  )
  return _sfc_setup$e ? _sfc_setup$e(props, ctx) : void 0
}
...
const _sfc_main$d = {
  ...
  setup(__props, { expose }) {
    const frontmatter = {
      ...
      cover:
        'https://cdn.jsdelivr.net/gh/qiyuor2/blog-image/img/20210122wuzhizhuansheng.jpeg',
      meta: [{ property: 'og:title', content: '\u65E0\u804C\u8F6C\u751F' }],
    }
    expose({ frontmatter })
    const head$1 = {
      title: '\u65E0\u804C\u8F6C\u751F',
...
_sfc_main$d.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext()
  ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'src/posts/2022/wu-zhi-zhuan-sheng.md'
  )
  return _sfc_setup$d ? _sfc_setup$d(props, ctx) : void 0
}
...
const posts$1 = formatter({
  '../../posts/2019/chsarp-sql-helper.md': __glob_0_0,
  '../../posts/2019/csharp-html-agility-pack-selenium.md': __glob_0_1,
  '../../posts/2019/csharp-html-agility-pack.md': __glob_0_2,
  '../../posts/2019/csharp-use-xml.md': __glob_0_3,
  '../../posts/2019/git-tutorial.md': __glob_0_4,
  '../../posts/2019/hexo-blog.md': __glob_0_5,
  '../../posts/2019/js-closure.md': __glob_0_6,
  '../../posts/2019/js-count-down.md': __glob_0_7,
  '../../posts/2019/js-move-pic-by-slider.md': __glob_0_8,
  '../../posts/2019/t-sql-note.md': __glob_0_9,
  '../../posts/2020/about-http.md': __glob_0_10,
  '../../posts/2020/build-vue-for-webpack.md': __glob_0_11,
  '../../posts/2020/deep-in-js-data-type.md': __glob_0_12,
  '../../posts/2020/electron-learn.md': __glob_0_13,
  '../../posts/2020/js-datastructure.md': __glob_0_14,
  '../../posts/2020/node-spider-csdn.md': __glob_0_15,
  '../../posts/2020/picgo-jsdelivr-github.md': __glob_0_16,
  '../../posts/2020/ts-builder.md': __glob_0_17,
  '../../posts/2020/ts-factory.md': __glob_0_18,
  '../../posts/2020/ts-observer.md': __glob_0_19,
  '../../posts/2020/ts-singleton.md': __glob_0_20,
  '../../posts/2020/ts-strategy.md': __glob_0_21,
  '../../posts/2020/use-github-actions.md': __glob_0_22,
  '../../posts/2021/chrome-ext-get-image.md': __glob_0_23,
  '../../posts/2021/difference-between-src-href.md': __glob_0_24,
  '../../posts/2021/github-actions-publish-package.md': __glob_0_25,
  '../../posts/2021/js-event-loop.md': __glob_0_26,
  '../../posts/2021/package-md-editor-for-rn.md': __glob_0_27,
  '../../posts/2021/simple-blog-generate.md': __glob_0_28,
  '../../posts/2021/webpack-multipage.md': __glob_0_29,
  '../../posts/2022/2021-review.md': __glob_0_30,
  '../../posts/2022/takagai-san.md': __glob_0_31,
  '../../posts/2022/tiger-and-dragon.md': __glob_0_32,
  '../../posts/2022/wu-zhi-zhuan-sheng.md': __glob_0_33,
})
function useNav() {
...
function _sfc_ssrRender$b(
  ...
  _push(
    `<div${serverRenderer.ssrRenderAttrs(
      vue.mergeProps({ class: 'posts-list' }, _attrs)
    )}><ul><!--[-->`
  )
  serverRenderer.ssrRenderList($setup.list, (post, i) => {
    _push(
      `<li class="posts-list__item"><h2 class="oneline">${serverRenderer.ssrInterpolate(
        post.title
      )}</h2><p>${serverRenderer.ssrInterpolate(post.summary)}</p></li>`
    )
  })
        ...
        { size: 'large' },
        {
          default: vue.withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              return [vue.createTextVNode('\u67E5\u770B\u66F4\u591A')]
            }
          }),
          _: 1,
        },
...
var List = /* @__PURE__ */ _export_sfc(_sfc_main$c, [
...
function _sfc_ssrRender$a(
  ...
  _push(
    `<article${serverRenderer.ssrRenderAttrs(
      vue.mergeProps({ class: 'article heti custom' }, _attrs)
    )}>`
  )
  _push(
    serverRenderer.ssrRenderComponent(
...
var Article = /* @__PURE__ */ _export_sfc(_sfc_main$b, [
  ...
  setup(__props, { expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(
        `<div${serverRenderer.ssrRenderAttrs(
          vue.mergeProps({ class: 'markdown-body' }, _attrs)
        )}><hr><p>\u5982\u4F60\u6240\u89C1\uFF0C\u5DEE\u4E0D\u591A\u662F\u4E2A\u5783\u573E\u3002</p><p>\u5F88\u4EAB\u53D7\u5199\u4EE3\u7801\u7684\u8FC7\u7A0B\uFF0C\u5F88\u559C\u6B22\u901A\u5173\u6E38\u620F\u7684\u6210\u5C31\u611F\uFF0C\u5F88\u8BA8\u538C\u6545\u4E8B\u5B8C\u7ED3\u540E\u7684\u7A7A\u865A\u611F\u3002</p><p>\u4EBA\u751F\u603B\u4F53\u4E0A\u662F\u6CA1\u6709\u610F\u4E49\u7684\uFF0C\u6240\u4EE5\u6211\u5E0C\u671B\u80FD\u8FC7\u4E0A\u4E0D\u7528\u52AA\u529B\u4E5F\u4E0D\u6101\u5403\u559D\u8FD9\u79CD\u6CA1\u6709\u610F\u4E49\u65E5\u5B50\uFF0C\u4F46\u662F\u5728\u4E0D\u540C\u7684\u4EBA\u751F\u9636\u6BB5\u6211\u4EEC\u53EF\u4EE5\u7ED9\u81EA\u5DF1\u7684\u4EBA\u751F\u8D4B\u4E88\u4E00\u4E9B\u610F\u4E49\uFF0C\u6240\u4EE5\u6211\u8FD8\u5728\u52AA\u529B\u7740\uFF0C\u52AA\u529B\u7740\u5411\u6CA1\u6709\u610F\u4E49\u7684\u751F\u6D3B\u524D\u8FDB\u3002</p><p>\u559C\u6B22\u5F53\u4E00\u4E2A\u89C2\u4F17\uFF0C\u867D\u7136\u4E5F\u5E0C\u671B\u5F97\u5230\u522B\u4EBA\u7684\u8BA4\u53EF\uFF0C\u4F46\u81EA\u5DF1\u5E94\u8BE5\u662F\u4E0D\u9002\u5408\u7AD9\u5728\u821E\u53F0\u4E2D\u592E\u3002\u548C\u4EBA\u76F8\u5904\u65F6\u5927\u90E8\u5206\u60C5\u51B5\u4E0B\u4E5F\u90FD\u662F\u5728\u8F93\u5165\uFF0C\u56E0\u4E3A\u4E0D\u77E5\u9053\u5982\u4F55\u7EC4\u7EC7\u8BED\u8A00\u53BB\u8F93\u51FA\u3002</p><hr><p>\u8FD9\u4E2A\u535A\u5BA2\u662F\u505A\u7ED9\u81EA\u5DF1\u770B\u7684\uFF0C\u5F53\u7136\u4E5F\u5E0C\u671B\u80FD\u8BA9\u522B\u4EBA\u770B\u5230\u5E76\u4E14\u80FD\u8BA9\u5927\u5BB6\u6709\u6240\u6536\u83B7\uFF0C\u4E0D\u8FC7\u5199\u7684\u4E1C\u897F\u90FD\u6CA1\u5565\u542B\u91D1\u91CF\u3002\u5E0C\u671B\u80FD\u591F\u5728\u7F51\u7EDC\u4E0A\u7559\u4E0B\u81EA\u5DF1\u7684\u75D5\u8FF9\u5427\u3002</p></div>`
      )
    }
  },
}
...
function _sfc_ssrRender$9(
  ...
  _push(
    `<article${serverRenderer.ssrRenderAttrs(
      vue.mergeProps({ class: 'about heti' }, _attrs)
    )}><p>\u5148\u7ED9\u81EA\u5DF1\u8D34\u70B9\u6807\u7B7E</p>`
  )
  if ($setup.about) {
...
var About = /* @__PURE__ */ _export_sfc(_sfc_main$9, [
...
function _sfc_ssrRender$8(
  ...
  _push(
    `<div${serverRenderer.ssrRenderAttrs(
      vue.mergeProps({ class: 'archives' }, _attrs)
    )}><ul><!--[-->`
  )
  serverRenderer.ssrRenderList($setup.posts, (item, i) => {
    _push(
      `<li class="archives-item"><span class="archives-item__date">${serverRenderer.ssrInterpolate(
        item.date
      )}</span><span class="archives-item__title oneline">${serverRenderer.ssrInterpolate(
        item.title
      )}</span></li>`
    )
  })
...
var Archives = /* @__PURE__ */ _export_sfc(_sfc_main$8, [
...
var Hide = /* @__PURE__ */ _export_sfc(_sfc_main$7, [
...
function _sfc_ssrRender$6(
  ...
  _push(
    `<div${serverRenderer.ssrRenderAttrs(
      vue.mergeProps({ class: 'links' }, _attrs)
    )}>`
  )
  _push(
    serverRenderer.ssrRenderComponent(
      _component_fe_grid_group,
      { gap: 2 },
      {
        default: vue.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              ...
              vue.createBlock(
                vue.Fragment,
                null,
                vue.renderList($setup.friends, (f, i) => {
                  return (
                    vue.openBlock(),
                    vue.createBlock(
                      _component_fe_grid,
...
var Links = /* @__PURE__ */ _export_sfc(_sfc_main$6, [
...
function _sfc_ssrRender$5(
  ...
  _push(
    `<div${serverRenderer.ssrRenderAttrs(
      vue.mergeProps({ class: 'talk' }, _attrs)
    )} data-v-3cf93f48>`
  )
  _push(
    serverRenderer.ssrRenderComponent(
          ...
          if (_push2) {
                            ...
                            },
                            {
                              default: vue.withCtx(
                                (_3, _push4, _parent4, _scopeId3) => {
                                  if (_push4) {
                                    _push4(
                                      `<div class="card__cover" data-v-3cf93f48${_scopeId3}>`
                                    )
                                    _push4(
                                      serverRenderer.ssrRenderComponent(
                                        _component_fe_image,
                                    ...
                                    _push4(
                                      `</div><div class="card__desc" data-v-3cf93f48${_scopeId3}><p class="title" data-v-3cf93f48${_scopeId3}>${serverRenderer.ssrInterpolate(
                                        p.title
                                      )}</p><p class="summary" data-v-3cf93f48${_scopeId3}>${serverRenderer.ssrInterpolate(
                                        p.summary
                                      )}</p></div>`
                                    )
                                  } else {
            ...
            return [
              ...
              vue.createBlock(
                vue.Fragment,
                null,
                vue.renderList($setup.posts, (p, i) => {
                  return (
                    vue.openBlock(),
                    vue.createBlock(
                      _component_fe_grid,
...
var Talk = /* @__PURE__ */ _export_sfc(_sfc_main$5, [
  ['ssrRender', _sfc_ssrRender$5],
  ['__scopeId', 'data-v-3cf93f48'],
])
const routes = [
...
function _sfc_ssrRender$4(
  ...
  _push(
    `<header${serverRenderer.ssrRenderAttrs(
      vue.mergeProps({ class: 'nav-bar' }, _attrs)
    )}><div class="nav-bar__info"><div class="profile">`
  )
  _push(
    serverRenderer.ssrRenderComponent(
      _component_fe_avatar,
      {
        class: 'profile__logo',
        src: $setup.LOGO_LINK,
      },
      ...
      },
      {
        icon: vue.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              $setup.theme === 'light-theme'
                ? (vue.openBlock(),
                  vue.createBlock(_component_moon, { key: 0 }))
                : (vue.openBlock(),
                  vue.createBlock(_component_sun, { key: 1 })),
            ]
          }
        }),
        _: 1,
...
var NavBar = /* @__PURE__ */ _export_sfc(_sfc_main$4, [
...
function _sfc_ssrRender$3(
  ...
  _push(
    `<footer${serverRenderer.ssrRenderAttrs(
      vue.mergeProps({ class: 'footer' }, _attrs)
    )}><div class="footer__copyright">QIYUOR2 \xA9 2021</div><div class="footer__links">`
  )
  _push(
    serverRenderer.ssrRenderComponent(
      _component_github,
...
var Footer = /* @__PURE__ */ _export_sfc(_sfc_main$3, [
...
function _sfc_ssrRender$2(
  ...
  _push(
    `<div${serverRenderer.ssrRenderAttrs(
      vue.mergeProps({ class: 'layout' }, _attrs)
    )}>`
  )
  _push(
    serverRenderer.ssrRenderComponent(_component_nav_bar, null, null, _parent)
  )
  _push(
    serverRenderer.ssrRenderComponent(
      _component_router_view,
  ...
  _push(
    serverRenderer.ssrRenderComponent(_component_x_footer, null, null, _parent)
  )
  _push(`</div></div>`)
}
...
var Layout = /* @__PURE__ */ _export_sfc(_sfc_main$2, [
...
function _sfc_ssrRender$1(
  ...
  _push(
    `<a${serverRenderer.ssrRenderAttrs(
      vue.mergeProps({ class: 'custom-link' }, _attrs)
    )}>`
  )
  _push(
    serverRenderer.ssrRenderComponent(
      _component_icon_link,
      {
...
var Link = /* @__PURE__ */ _export_sfc(_sfc_main$1, [
...
function _sfc_ssrRender(
  ...
  _push(
    `<!--[--><link${serverRenderer.ssrRenderAttr(
      'href',
      $setup.FONT_LINK
    )}><link rel="stylesheet"${serverRenderer.ssrRenderAttr(
      'href',
      $setup.HETI_LINK
    )}>`
  )
  _push(
    serverRenderer.ssrRenderComponent(_component_Layout, null, null, _parent)
  )
  _push(`<!--]-->`)
}
