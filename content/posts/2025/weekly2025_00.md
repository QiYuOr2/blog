...
tags:
  ...
  - Suspense
summary: >-
  作者以个人反思和生活记录为主线，讲述了离开工作后决心通过周记系列推动自我成长，并分享了关于消除异步传染性的技术方案：通过改写fetch并利用throw与缓存结果，使同步代码读取异步数据且不改变后续函数逻辑。此外还涉及线下交流带来的沟通感悟、对《安达与岛村》细腻心理描写的阅读体验，以及对《FGO》2.6章剧情的评价与热爱。
---
