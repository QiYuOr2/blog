...
description: >-
  当我还在感叹 Github Copilot 辅助写代码有多方便的时候、思考普通人能用 GPT 做什么事的时候，AI
  就已经突然发展到了一个我看不懂的地步，突然冒出了诸如 Agent、RAG、MCP 这类陌生的名词。本篇文章梳理一下这些名词究竟是什么。
category: 技术
tags:
  - AI
  - Agent
  ...
  - 笔记
summary: >-
  本文梳理了AI领域四个关键概念：LLM是基础的语言模型，但依赖静态数据且可能产生幻觉；Agent通过调用工具让LLM能自主执行任务；RAG通过外部知识检索优化LLM的生成准确性；MCP则是连接LLM与外部数据服务的协议。文章旨在帮助读者理解这些新兴术语的实际含义与作用。
---
